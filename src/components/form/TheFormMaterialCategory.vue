    ...
    <div class="form_detail">
      ...
      <div class="content_add_unit">
        <div class="add_unit_item">
          ...
          <BaseInput
            style="width: 250px"
            v-model="materialCategory.categoryCode"
            :required="true"
            ref="categoryCode"
            :messError="categoryCodeNotEmpty"
          />
        </div>
        <div class="add_unit_item">
          <div class="add_unit_name">
          ...
          <BaseInput
            style="width: 250px"
            v-model="materialCategory.categoryName"
            :required="true"
            ref="categoryName"
            :messError="categoryNameNotEmpty"
          />
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      getNewForm: false,
      categoryCodeNotEmpty: Resource.ERROR_VALIDATE_FE.CategoryCodeNotEmpty,
      categoryNameNotEmpty: Resource.ERROR_VALIDATE_FE.CategoryNameNotEmpty,
      //Popup
      popup: {
